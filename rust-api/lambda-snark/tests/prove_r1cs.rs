...
fn test_prove_r1cs_quotient_correctness_at_beta() {
    ...
    assert_eq!(lhs, rhs, "Q(β) · Z_H(β) should equal A_z(β) · B_z(β) - C_z(β)");
}
...
fn test_prove_r1cs_deterministic() {
    ...
    assert_eq!(lhs1, rhs1, "Proof1 should satisfy verification equation at α");
    ...
    assert_eq!(lhs2, rhs2, "Proof2 should satisfy verification equation at α");
}
