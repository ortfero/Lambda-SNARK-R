...
///
/// Total: 10 R1CS constraints (6 logical + 4 padding rows)
pub fn build_healthcare_circuit(modulus: u64) -> R1CS {
    ...
    // Ensure square system (m = n) for downstream formal proofs.
    // Zero rows keep semantics unchanged while adding empty constraints.
...
///
/// Steps:
/// 1. Build the circuit and witnesses.
/// 2. Check constraint satisfaction for the HIGH-risk witness.
/// 3. Export the R1CS instance as a Lean term artifact.
